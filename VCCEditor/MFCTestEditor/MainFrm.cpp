...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	mdiTabParams.m_bActiveTabCloseButton = TRUE;      // establecer en FALSE para colocar el botón Cerrar a la derecha del área de fichas
	mdiTabParams.m_bTabIcons = FALSE;    // establecer en TRUE para habilitar iconos de documento en las fichas de MDI
	mdiTabParams.m_bAutoColor = TRUE;    // establecer en FALSE para deshabilitar el color automático de las fichas de MDI
	mdiTabParams.m_bDocumentMenu = TRUE; // habilitar el menú de documento en el borde derecho del área de fichas
