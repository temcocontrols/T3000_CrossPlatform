namespace PRGReaderLibrary
{
    ...
    {
        public static string BooleanToDigitalValue(bool value, Units units, List<CustomUnitPoint> customUnits = null) =>
            value ? units.GetOnName(customUnits) : units.GetOffName(customUnits);

        public static bool DigitalValueToBoolean(string value, Units units, List<CustomUnitPoint> customUnits = null)
        {
...
CustomUnits: {customUnits}");
        ...
        public static string ConvertValue(string value, Units fromUnits, Units toUnits, List<CustomUnitPoint> fromCustomUnits = null, List<CustomUnitPoint> toCustomUnits = null)
        {
