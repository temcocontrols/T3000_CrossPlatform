...
1. Run the .sln file(VS2015 Community Edition)<details><summary>Image</summary>![](documents/run.png)</details>
...
3. Start up(F5 or click to Start)<details><summary>Image</summary>![](documents/start.png)</details>
