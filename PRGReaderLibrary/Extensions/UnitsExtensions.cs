namespace PRGReaderLibrary
{
    ...
    public static class UnitsExtensions
    {
        ...
        public static UnitsNames GetUnitsNames(this Units units, List<CustomUnit> customUnits = null)
        {
...
Units: {units}", nameof(units));
        ...
        public static string GetOffName(this Units units, List<CustomUnit> customUnits = null) =>
            GetUnitsNames(units, customUnits).OffName;

        public static string GetOnName(this Units units, List<CustomUnit> customUnits = null) =>
            GetUnitsNames(units, customUnits).OnName;

        public static string GetOffOnName(this Units units, List<CustomUnit> customUnits = null) =>
