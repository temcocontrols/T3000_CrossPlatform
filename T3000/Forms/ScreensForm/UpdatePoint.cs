...
namespace T3000.Forms
{
    class UpdatePoint
    {
        ...
        public Boolean Update_point(int param_idprg, String param_lblname,String param_image, int param_screenid)
        {
            ...
            if (conn.Sqlite_Connect())
            {
                ...
                try
                {
                    ...
                    string sql = "UPDATE AtributosLabels SET lbl_name='"+param_lblname+"',lbl_text='"+param_lblname+"',image='"+param_image+"' WHERE id_prg ="+param_idprg+" AND link="+param_screenid;
